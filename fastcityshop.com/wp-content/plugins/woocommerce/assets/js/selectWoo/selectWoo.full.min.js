            ...
            return t && t.requirejs || (t ? i = t : t = {}, function(e) {
                    ...
                    s = function(e, t) {
                        var n, i, o = _(e),
                            r = o[0],
                            s = t[1];
                        return e = o[1], r && (n = w(r = m(r, s))), r ? e = n && n.normalize ? n.normalize(e, (i = s, function(e) {
                            return m(e, i)
                        })) : m(e, s) : (r = (o = _(e = m(e, s)))[0], e = o[1], r && (n = w(r))), {
                            f: r ? r + "!" + e : e,
                            n: e,
                            pr: r,
                            p: n
                        ...
                        var r, u, p, h, f, m, _, b = [],
                            x = typeof i;
                        if (m = $(o = o || t), "undefined" === x || "function" === x) {
                            ...
                            p = i ? i.apply(l[t], b) : undefined, t && (r && r.exports !== e && r.exports !== l[t] ? l[t] = r.exports : p === e && _ || (l[t] = p))
                        } else t && (l[t] = i)
                    }, n = i = r = function(n, i, o, l, c) {
                        if ("string" == typeof n) return a[n] ? a[n](i) : w(s(n, $(i)).f);
                        if (!n.splice) {
                    ...
                    return i.prototype.on = function(e, t) {
                        ...
                        return "undefined" == typeof t._isTouchscreenCache && (t._isTouchscreenCache = "ontouchstart" in document.documentElement), t._isTouchscreenCache
                    }, t
                    ...
                    return t.Extend(n, t.Observable), n.prototype.render = function() {
                        ...
                        this.data.current(function(n) {
                            ...
                            t.$results.find(".select2-results__option[data-selected]").each(function() {
                                var t = e(this),
                                    n = e.data(this, "data"),
                                    o = "" + n.id;
                                null != n.element && n.element.selected || null == n.element && e.inArray(o, i) > -1 ? t.attr("data-selected", "true") : t.attr("data-selected", "false")
                            })
                        })
                        ...
                        for (var o in t.disabled && (delete i["data-selected"], i["aria-disabled"] = "true"), null == t.id && delete i["data-selected"], null != t._resultId && (n.id = t._resultId), t.title && (n.title = t.title), t.children && (i["aria-label"] = t.text, delete i["data-selected"]), i) {
                            var r = i[o];
                            n.setAttribute(o, r)
                        }
                        if (t.children) {
                        ...
                        this.$results.attr("id", o), t.on("results:all", function(e) {
                            ...
                            var e = i.$results.parents(".select2-container").find("input.select2-search__field")[0];
                            void 0 !== e && e.focus()
                        }), t.on("close", function() {
                            ...
                            if (0 !== e.length) {
                                var t = e.data("data");
                                "true" == e.attr("data-selected") ? i.trigger("close", {}) : i.trigger("select", {
                                    data: t
                                })
                            }
                            ...
                            e.element.addClass("select2-results__option--highlighted").attr("aria-selected", "true"), i.$results.attr("aria-activedescendant", e.element.attr("id"))
                            ...
                            var n = e(this),
                                o = n.data("data");
                            "true" !== n.attr("data-selected") ? i.trigger("select", {
                                originalEvent: t,
                                data: o
                    ...
                    return t.Extend(i, t.Observable), i.prototype.render = function() {
                        ...
                        e(document.body).on("mousedown.select2." + t.id, function(t) {
                            ...
                            e(".select2.select2-container--open").each(function() {
                                var t = e(this);
                                this != i[0] && (t.data("element").select2("close"), setTimeout(function() {
                    ...
                    return n.Extend(o, t), o.prototype.render = function() {
                        ...
                        "string" == typeof r ? this.$selection.attr("aria-label", r) : this.$selection.attr("aria-labelledby", i), this.$selection.attr("role", "combobox"), this.$selection.on("mousedown", function(e) {
                        ...
                        if (this.clear(), 0 !== e.length) {
                            for (var t = [], i = 0; i < e.length; i++) {
                                var o = e[i],
                                    ...
                                    s = r.html(),
                                    a = this.display(o, r);
                                "string" == typeof a && (a = n.entityDecode(a.trim())), r.text(a), r.prepend(s), r.prop("title", o.title || o.text), r.data("data", o), t.push(r)
                            }
                    ...
                    return t.prototype.normalizePlaceholder = function(e, t) {
                        ...
                        return i.text(e.entityDecode(this.display(n))), i.addClass("select2-selection__placeholder").removeClass("select2-selection__choice"), i
                    ...
                    return e.Extend(t, e.Observable), t.prototype.current = function(e) {
                        ...
                        var i = "";
                        return i += null != t ? t.id : e.generateChars(4), i += "-result-", i += e.generateChars(4), null != n.id ? i += "-" + n.id.toString() : i += "-" + e.generateChars(4), i
                    }, t
                    ...
                    return t.Extend(i, e), i.prototype._applyDefaults = function(e) {
                        ...
                        function r() {
                            var n = o.transport(o, function(n) {
                                ...
                                i.options.get("debug") && window.console && console.error && (o && o.results && Array.isArray(o.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), t(o), i.container.focusOnActiveElement()
                            }, function() {
                                n.status && "0" === n.status || i.trigger("results:message", {
                    ...
                    function t(e, t, n) {
                        ...
                        if (r !== undefined && (this.insertTag = r), e.call(this, t, n), Array.isArray(i))
                    ...
                    return n.prototype.render = function(t) {
                        var n = t.call(this),
                            i = e('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="text" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="combobox" aria-autocomplete="list" aria-expanded="true" /></span>');
                        ...
                        t.call(this, n, i), this.$search.on("keydown", function(e) {
                            ...
                            o.$search.attr("tabindex", 0), o.$search.attr("aria-owns", r), o.$search.trigger("focus"), window.setTimeout(function() {
                                o.$search.trigger("focus")
                            }, 0)
                        }), n.on("close", function() {
                            o.$search.attr("tabindex", -1), o.$search.removeAttr("aria-activedescendant"), o.$search.removeAttr("aria-owns"), o.$search.val("")
                        }), n.on("focus", function() {
                    ...
                    return D.prototype.apply = function(d) {
                        ...
                        this.defaults = {
                            ...
                            matcher: function n(i, o) {
                                if (null == i.term || "" === i.term.toString().trim()) return o;
                    ...
                    return n.Extend(o, n.Observable), o.prototype._generateId = function(e) {
                        ...
                        this.on("open", function() {
                            ...
                            var n = e.which;
                            if (t.isOpen()) {
                                n === i.ESC || n === i.UP && e.altKey ? (t.close(), e.preventDefault()) : n === i.ENTER || n === i.TAB ? (t.trigger("results:select", {}), e.preventDefault()) : n === i.SPACE && e.ctrlKey ? (t.trigger("results:toggle", {}), e.preventDefault()) : n === i.UP ? (t.trigger("results:previous", {}), e.preventDefault()) : n === i.DOWN && (t.trigger("results:next", {}), e.preventDefault());
                                var o = t.$dropdown.find(".select2-search__field");
                                o.length || (o = t.$container.find(".select2-search__field")), n === i.DOWN || n === i.UP ? t.focusOnActiveElement() : (o.trigger("focus"), setTimeout(function() {
                                    t.focusOnActiveElement()
                                }, 1e3))
                            } else t.hasFocus() && (n !== i.ENTER && n !== i.SPACE && n !== i.DOWN || (t.open(), e.preventDefault()))
                        })
                        ...
                        var n = t[0];
                        Array.isArray(n) && (n = e.map(n, function(e) {
                            return e.toString()
                    ...
                    return {
                        syncCssClasses: function(t, n, i) {
                            var o, r, s = [];
                            (o = t.attr("class") || 0 == t.attr("class") ? t.attr("class").toString().trim() : "") && e((o = "" + o).split(/\s+/)).each(function() {
                                0 === this.indexOf("select2-") && s.push(this)
                            }), (o = n.attr("class") || 0 == n.attr("class") ? n.attr("class").toString().trim() : "") && e((o = "" + o).split(/\s+/)).each(function() {
                    ...
                    return i.prototype.render = function(e) {
                        ...
                        return "function" == typeof a && (a = a(this.$element)), t.syncCssClasses(i, this.$element, r), i.css(a), i.addClass(o), i
                    }, i
                ...
                r = function(e) {
                    ...
                    return null != e.fn.select2 && null != e.fn.select2.defaults && (e.fn.selectWoo.defaults = e.fn.select2.defaults), null == e.fn.selectWoo.defaults && (e.fn.selectWoo.defaults = i), e.fn.select2 = e.fn.select2 || e.fn.selectWoo, n
                }), {
                    define: t.define,
                    require: t.require
                }
